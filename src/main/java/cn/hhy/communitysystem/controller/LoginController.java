...
import cn.hhy.communitysystem.util.RedisKeyUtil;
...
public class LoginController implements CommunityConstant {
    ...
    // 用户从邮件点击返回地址http://localhost:8080/community/activation/101/code
